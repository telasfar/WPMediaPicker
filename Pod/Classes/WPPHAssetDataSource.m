...
+ (NSPredicate *)predicateForFilterMediaType:(WPMediaType)mediaType
{
    ...
    if (mediaType & WPMediaTypeVideo) {
        [predicates addObject:[NSPredicate predicateWithFormat:@"(mediaType == %d) && !((mediaSubtype & %d) == %d) && !((mediaSubtype & %d) == %d)", PHAssetMediaTypeVideo, PHAssetMediaSubtypeVideoHighFrameRate, PHAssetMediaSubtypeVideoHighFrameRate,PHAssetMediaSubtypeVideoTimelapse,PHAssetMediaSubtypeVideoTimelapse]];
